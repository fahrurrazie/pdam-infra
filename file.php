...
if(isset($_GET['open'])) {
	switch ($_GET['open']){	
		default			: if(!file_exists ("membagusi/beranda.php")) die ("File tidak ada"); 
								include "membagusi/beranda.php"; break;

		case '' 		: if(!file_exists ("membagusi/beranda.php")) die ("File tidak ada"); 
								include "membagusi/beranda.php"; break;
		...
		case 'rekapperawatantek'   :if(!file_exists ("rekapperawatantek.php")) die ("File tidak ada"); 
								include "rekapperawatantek.php";  break;
		...
		case 'proses_perbaikan'   :if(!file_exists ("proses_perbaikan.php")) die ("File tidak ada"); 
								include "proses_perbaikan.php";  break;
	...
	if(!file_exists ("membagusi/beranda.php")) die ("File tidak ada"); 
		include "membagusi/beranda.php"; 
}
?>