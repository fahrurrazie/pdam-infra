...
$result = $koneksi->query("SELECT b.nik, b.nama, COUNT(*) AS jumlah FROM perbaikan a JOIN karyawan
                  b ON a.teknisi = b.id where tanggal like '$bulan%'
                  GROUP BY b.nama order by jumlah DESC") ->fetch_all(MYSQLI_ASSOC); 
...
$pdf->Cell(130);
$pdf->Cell(30,10,'Rekap Kinerja Perbaikan '.$nama_bulan,0,0,'C');
$pdf->Ln();
...
$pdf->Row(array('No','NIK','Nama','Jumlah Perbaikan'));
