...
$result = $koneksi->query("SELECT c.nik, c.nama, COUNT(*) AS jumlah FROM perawatan a JOIN  
                  perawatan_detail b ON a.id = b.id_perawatan 
                  JOIN karyawan c ON a.id_karyawan = c.id
...
$pdf->Cell(130);
$pdf->Cell(30,10,'Rekap Kinerja Perawatan '.$nama_bulan,0,0,'C');
$pdf->Ln();

//table Head
$pdf->SetFont('Arial','B',10);
$pdf->SetWidths(array(40,80,80,80)); //280
$pdf->SetAligns(array('C','C','C','C'));
$pdf->Row(array('No','NIK','Nama','Jumlah Perawatan'));
...

{
    ...
    $pdf->Row(array($x,$nik,$nama,$jumlah));
    $x++;
}
