...
<div class="box box-solid box-primary">
   <div class="box-header with-border">
      <h3 class="box-title">REKAP PEMBELIAN</h3>   
        <a class="btn btn-info pull-right" href='index_admin.php?open=pembelian'>Tambah Data</a>
    </div>
    <div class="box-body">
      <div>
...
function tampil(){
  ...
  if ($('#bulan').val()==''){bulan="-";}
  $('#example2').dataTable( {
      "ajax": "tampil.php?data=rekappembelian&bulan="+bulan,
      "destroy": true,
      "columns": [
          { "data": "aksi" },
          { "data": "aksi" },
...
$("#cetak").on('click',function(){
  if ($('#bulan').val()==''){
    ...
    var bulan=$('#bulan').val();
    window.open("laprekappembelian.php?bulan="+bulan);
  }
});  
...
$("#example2").on('click','.hapus',function(){
    ...
    .then((willDelete) => {
    if (willDelete) {
      return $.post("hapus.php?hapus=pembelian&id="+id, function(data) {
