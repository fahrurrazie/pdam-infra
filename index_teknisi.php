      ...
      <li class="dropdown notifications-menu">
          ...
          <li>   
             <div class="dropdown-divider"></div>
                  ...
                  <a href="index_teknisi.php?open=perbaikan" class="dropdown-item">
        ...
        <section class="sidebar" id="scroll-sidebar">
         ...
         <li style="margin:1%;"></li>
          <ul class="sidebar-menu">
            <li class="header"><b> MENU UTAMA TEKNISI</b></li>  
<style type="text/css">
  .upper { text-transform: uppercase; }
</style>
            <li><a href="index_teknisi.php?open=" class="upper"><i class="fa fa-home"></i><?php
                          $nama=$_SESSION['username'];
                          echo "$nama";
                          ?></a></li>  
            ...
            <li class='treeview'>
              ...
              <ul class='treeview-menu'>
                <li><a href='index_teknisi.php?open=barang'><i class='fa fa-dropbox'></i>Barang</a></li>
                <li><a href='index_teknisi.php?open=departemen'><i class='fa fa-dropbox'></i>Departemen</a></li>
              </ul>
            </li>
            <li class='treeview'>
              <a href='#'><i class='fa fa-random'></i> <span>TRANSAKSI</span><i class='fa fa-angle-left pull-right'></i></a>
              <ul class='treeview-menu'>
                <li><a href='index_teknisi.php?open=aduan_perbaikan'><i class='fa fa-random'></i>Aduan</a></li>
                <li><a href='index_teknisi.php?open=perbaikan'><i class='fa fa-random'></i>Proses Aduan</a></li>
                <li><a href='index_teknisi.php?open=permintaan'><i class='fa fa-random'></i>Permintaan</a></li>
                <li><a href='index_teknisi.php?open=penyerahan'><i class='fa fa-random'></i>Penyerahan</a></li>
                <li><a href='index_teknisi.php?open=peminjaman'><i class='fa fa-random'></i>Peminjaman</a></li>
                <li><a href='index_teknisi.php?open=permintaan'><i class='fa fa-random'></i>Permintaan</a></li>
                <li><a href='index_teknisi.php?open=rekapperawatantek'><i class='fa fa-random'></i>perawatan</a></li>
